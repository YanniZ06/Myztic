...
namespace Myztic {
	...
	enum EventType {
		/*Reference Struct `DefaultDeviceChangedEvent`*/
	...
	public:
		 ...
		 * \param id An unsigned integer id to identify this callback by. Use `getNextFreeIdFor(type)` to get a unique id for your type.
		 ...
		 * 
		 * \param type `EventType` you want to remove the callback for.
		 * \param id The unsigned integer id to identify this callback by.
